...
const Charrua = () => {
  ...
  const valorDiaria = 490; // Preço da diária em reais (R$)
  ...
  return (
    <div className="container-domo">
      <img
        ...
        src="../../../images/charuabus.jpeg"
        alt="Charrua"
      />
      <div className="texto-acomodacao">
        <h2 className="titulo-acomodacao"><strong>Charrua</strong></h2>
        <p>
