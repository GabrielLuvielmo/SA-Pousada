...
function Home(){
    ...
    return (
        <div className='main-home'>
            <div className='ibagem-fundo'>
                <img src='../../../images/FundoPousadaSA.png'/>
            </div>
            <br />
            ...
            <h3 className='texto'>
                ...
                rústico e agradável.  Ideal para quem gosta de fugir da rotina e procura um local de paz para descansar e curtir a natureza.
                 <b>"O Ypuã tem tudo a ver com a natureza, dá para sentir a energia do lugar.</b> Eu me preocupo se você vai comer bem,
            ...
            <Link to="/cadastro" className='btn-7'>Veja mais!</Link>
            <br />
        </div>
